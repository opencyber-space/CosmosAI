...
# --- Configuration ---
#WEBSOCKET_URI = "ws://CLUSTER1MASTER:31690"

# --- Page Setup ---
st.set_page_config(page_title="Streaming Chat", page_icon="🤖")
st.title("🤖 Streaming WebSocket Chat")

st.session_state.BLOCKID = args.block_id  # Use the block ID from command line argument
GRPC_SERVER_ADDRESS = args.grpc_server_address  # Use the gRPC server address from command
# --- Session State Initialization ---
# Initialize chat history and other session variables
if "BLOCKID" not in st.session_state:
    st.session_state.BLOCKID = "gemma3-27b-block"  # Define your block ID here
