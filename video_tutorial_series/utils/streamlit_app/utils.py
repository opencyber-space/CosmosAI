...
def run_streamlit_direct(block_id, grpc_server_address, port=8501):
    """
    Run streamlit directly and return the public URL
    """
    try:
        ...
        app_path = "/home/srikanth_g_cognitif_ai/files_from_local/documentation/video_tutorial_series/utils/streamlit_app/app_single_model_orig.py"
        ...
        print(f"🚀 Starting Streamlit with command:")
        print(" ".join(command))
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                print(f"🔌 gRPC Server: {grpc_server_address}")
