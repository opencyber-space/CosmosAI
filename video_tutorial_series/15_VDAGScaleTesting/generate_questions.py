...
def fetch_gemini_questions(api_key, questions_file, count):
    ...
    with open(questions_file, 'a') as f:
        for cnt in range(count):
            ...
            prompt = f"Give me a unique, non-trivial, open-ended {topic} question suitable for an LLM benchmark. Do not repeat previous questions. Keep Question within 32 tokens."
            data = {
                "contents": [
