...
class AIOSv1PolicyRule:
    def __init__(self, rule_id, settings, parameters):
        ...
        self.weights = self.parameters.get("weights", {
            ...
            "running_counter": 0.0  # Cumulative requests since last metrics update
        })
        ...
        default_metric_configs = {
            ...
            "running_counter": {"max_threshold": 1000, "invert_score": True}  # Lower counter is better
        }
    ...
    def _get_metric_value(self, instance: Dict[str, Any], metric_name: str, input_data: Dict[str, Any] = None) -> float:
        ...
        if metric_name == "active_sessions":
            ...
            return 0
        elif metric_name == "running_counter":
            instance_id = instance.get('instanceId')
            return self.instance_request_counters.get(instance_id, 0)
        else:
